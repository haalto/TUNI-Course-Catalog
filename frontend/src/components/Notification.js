    ...
    return (
      <div className="alert alert-danger">
        <p>
            ...
            application is (atleast to my knowledge) only available for four faculties and Tampere University Language Centre.
            The data is very limited in details and it might contain incorrect information regarding course details, 
            so please be aware of that and double check the course infromation from the official site.
        </p>
        <p>
